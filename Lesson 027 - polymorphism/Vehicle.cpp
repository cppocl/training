...
{
    std::cout << "Vehicle constructor for " << GetManufacturer() << " " << GetModel() << std::endl;
}

Vehicle::~Vehicle()
{
    std::cout << "Vehicle destructor for " << GetManufacturer() << " " << GetModel() << std::endl;
}
...
{
    std::string description = GetManufacturer();
    description += ", ";
    description += GetModel();
    std::string number_of_wheels = std::to_string(GetNumberOfWheels());
    description += ", ";
    description += number_of_wheels;
    description += " wheels";
    return description;
}